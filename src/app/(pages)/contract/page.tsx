  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white pt-20">
        ...
        <div className="max-w-6xl mx-auto text-center mb-20 mt-20 py-16 px-8">
          <h1 className="text-6xl font-bold mb-4">Explore the YieldUSD Contract</h1>
          <p className="text-xl text-gray-400">
            This page showcases the core logic and design behind <strong>YieldUSD</strong> — a smart contract that turns USDC deposits into yield-bearing tokens (yUSD). Track the flow, check features, and dive into the code.
          </p>
        </div>
      </AnimatedSection>
            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-400 text-lg">
                        YieldUSD contract ensures fair and transparent yield distribution:
                    </p>
                </div>
            </div>
